  ...
  return (
    <>
      <div className="overflow-hidden relative w-screen min-h-screen bg-gradient-to-b top-0 from-[#FFF9F6] to-[#FFE2D5] justify-center items-center">
        ...
        <div className="relative z-10 w-full font-[Nobile] max-w-4xl transform scale-90 mt-15 mb-15 md:scale-100 my-20 my-60 lg:mx-30 p-4 md:p-8">
          <h1 className="text-[#412200] font-bold text-4xl sm:text-5xl mb-10">
            Log In
          </h1>
          ...
          <form
            ...
            className="flex flex-col gap-4 lg:flex-col md:gap-6 w-full max-w-xs md:max-w-full"
          >
            ...
            <div className="flex flex-col gap-2">
              <label
                htmlFor="password"
                className="font-bold text-2xl mt-10 sm:text-2xl text-[#412200]"
              >
                Password*
              </label>
            ...
            <p className="text-[#412200] font-medium text-lg sm:text-xl mt-11 w-4/5 md:w-full">
              ...
              <Link to="/signup" className="text-[#DD006B] underline">
                Create one
              </Link>
            </p>
          </form>
